                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="bg-light p-4">
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <p class="mb-4">
                                                        <b class="c-purple">COVERAGE:</b> Interviews were distributed across regions to create a nationally representative sample. Thirty-nine percent (39%) of the interviews took place in Castries, followed by 13% in Gros Islet, 10% in Vieux Fort, and the remaining 38% in other regions.
                                                    </p>
                                                    <p class="mb-4">
                                                        <b class="c-purple">GEOGRAPHY:</b> Seventy-two percent (72%) of respondents resided in rural areas and municipalities, while 28% of respondents resided in metro areas or cities.
                                                    </p>
                                                    <p class="mb-4">
