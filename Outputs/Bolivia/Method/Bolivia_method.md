...
================
                    ...
                    <div class="container mb-4 pt-5">
                        ...
                        <div class="row justify-content-center mb-3">
                            <div class="col-md-11">
                                ...
                                <p class="mb-4">
                                    The GPP in Bolivia was conducted for the WJP's The Rule of Law in Bolivia: *Key Findings from the General Population Poll 2022* with sampling, fieldwork, and data processing by Capture Consulting, based in Santa Cruz, Bolivia. Capture Consulting administered the surveys between June and July 2022, conducting face-to-face interviews using a multi-stage random sampling design. The target population group for this survey included 1000 aged 18 years or older residing across 32 cities throughout the country.
                                </p>
                                <p class="mb-0 c-purple"><b>SAMPLE SIZE & SAMPLE FRAME</b></p>
                                <p class="mb-4">
                                    The General Population Poll in Bolivia represents an achieved total sample size of 1000 interviews distributed proportionally across all 9 9. Capture Consulting based the sampling frame on the 2020 projected population figures from the National Statistics Institute, acquiring a proportionally stratified sample by region, age, gender, socioeconomic status, and level of urbanization.
                                    <br><br>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="bg-light p-4">
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <p class="mb-4">
                                                        <b class="c-purple">COVERAGE:</b> Interviews were distributed across regions to create a nationally representative sample. The majority of interviews were conducted in the Santa Cruz region (28%), followed by the La Paz region (25%) and the Cochabamba region (18%).
                                                    </p>
                                                    <p class="mb-4">
                                                        <b class="c-purple">GEOGRAPHY:</b> Forty-seven percent (47%) of respondents reside in rural areas and municipalities, while 53% of respondents reside in metro areas or cities.
                                                    </p>
                                                    <p class="mb-4">
                                                        <b class="c-purple">ETHNICITY:</b> Almost half of all respondents (49%) identified themselves as Mestizo, followed by Aymara (22%) and Quechua (21%).
                                                    </p>
                                                    <p class="mb-4">
        ...
        <tr>
            ...
            <td class="text-right">   NA</td>
                                        ...
                                        <p class="mb-4">
                                            In total, 71 interviewers worked on this project, including 45 female interviewers. .na.character. Interviews were conducted in Spanish.
                                            <br><br>
